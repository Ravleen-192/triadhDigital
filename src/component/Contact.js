  ...
  render() {
    ...
    return (
      <div className="container-fluid text-center">
          ...
          <Col md="12" sm="12" xs="12" lg="12" xl="12">
            <div className ="text-center vcenter">
              <Col className=" vcenter">
                <h6 className="content">LET’S TALK</h6>
                <p className="content mt_20">Reach out to us so we can help you transform your business.</p>   
              </Col>
            </div>
          </Col>
        </div>
        ...
        <div className="row">
          <Col md="12" sm="12" xs="12" lg="12" xl="12">
            <div className ="text-center vcenter contact">
              <Col className=" vcenter">
                <h6 className="title-txt">TELL US ABOUT YOU</h6>   
              </Col>
            </div>
            <div className ="text-center vcenter contact-text ">
              <Col className=" vcenter form-area">
                <div className="row mt_20">
                ...
                <div className="row mt_20 mb_20">
                  <Col md="2"lg="2" xl="2"></Col>
                  <Col md="3" sm="3" xs="3" lg="3" xl="3">
                    <Label className="content lbl_txt">Company Name<sup className="red_star">*</sup></Label>
                  </Col>
                  <Col md="4" sm="9" xs="9" lg="4" xl="4">
                  <span className="sup_li">:</span>
                    <input type="text" className="form-control" 
                      value ={contactModel.comname?contactModel.comname:''}
                      ref = {"comname"}
                      onChange={(event)=>{
                        event.preventDefault();
                        contactModel.comname = event.target.value;
                        this.setState({contactModel,companyError:null})
                      }}
                      maxLength={30} required></input>
                      {this.state.companyError?<span className="error-lbl">{this.state.companyError}</span>:null}
                  </Col>
            ...
            <div className ="text-center vcenter contact-text mb_20">
              <Col className=" vcenter form-area">
                <div className="row mt_20 mb_20">
                  <Col md="2" lg="2" xl ="2"></Col>
