    ...
    render() {
        return (
            <div className="container-fluid text-center">
                ...
                <div className="row mt_2 mb_2">
                    <Col className="td__header-content" md="12" sm="12" xs="12" lg="12" xl="12">
                        <h2 >Our Expertise: </h2>
                        <p>DEEP LEARNING. MACHINE VISION. DATA STRATEGY. DATA PRODUCT. DATA MESH. SERVICENOW.  <strong className="link" onClick={() => this.props.onClickMenuItem(4)}> Contact Us </strong></p>
                    </Col>
                ...
                <div className=" row container-fuild mt_2 mb_2" md="12" sm="12" xs="12" lg="12" xl="12">
                    <div className="td__header" >
                        <div className=" td__header-content" md="6" sm="6" xs="6" lg="6" xl="6">
                            <p>DEEP LEARNING :kdjfhskdfhskdfhsdf<br />
                                MACHINE VISION:skdjfhskdfhskdfhskfd<br />
                                DATA STRATEGY:sdkfjhskdfhskfdh <br />
                                DATA PRODUCT:sdjfhskdfhskdfhsf <br />
                                DATA MESH :sdlfhskfdhskdfskdf<br />
                                SERVICE NOW:wlsljfhswfhskdfh ​</p>
                                ...
                                <div className="card bg_img_sfront_1">
                                    <div className="card-body text-center">
                                        <Col md="12 text-center vcenter" sm="12" xs="12" lg="12" xl="12">
                                            <p className="card-text">Consulting Services </p>
                                        </Col>
                                    </div>
                                </div>
                            </div>
                        ...
                        <ReactCardFlip isFlipped={this.state.isFlipped2} flipDirection="horizontal" infinite flipSpeedFrontToBack={1.5} flipSpeedBackToFront={1.5}>
                            <div className="frontside" onClick={(e) => this.handleClick(e, "second")}>
                                <div className="card bg_img_sfront_2">
                                    <div className="card-body text-center">
                                        <Col md="12 text-center vcenter" sm="12" xs="12" lg="12" xl="12">
                                            <p className="card-text serv-second-card">Managed and Professional Services</p>
                                        </Col>
                                    </div>
                                </div>
                            </div>
                        ...
                        <ReactCardFlip isFlipped={this.state.isFlipped3} flipDirection="horizontal" infinite flipSpeedFrontToBack={1.5} flipSpeedBackToFront={1.5}>
                            <div className="frontside" onClick={(e) => this.handleClick(e, "third")}>
                                <div className="card bg_img_sfront_3">
                                    <div className="card-body text-center">
                                        <Col md="12 text-center vcenter" sm="12" xs="12" lg="12" xl="12">
                                            <p className="card-text">Staffing Services</p>
                                        </Col>
                                    </div>
                                </div>
                            </div>
