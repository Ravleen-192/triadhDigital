    ...
    render() {
        return (
            <div className="container-fluid ">
                <Helmet>
                    <meta charSet="utf-8" />
                    <title>AI, ML, Deep Learning Turn-key and Tailor-made Solutions and Helios</title>
                    <meta name="description" content="AI, ML, Deep Learning, ComputerVision, Pose, Facial, Object, Speech-to-text, text-to-speech, AWS SageMaker Helios" />
                ...
                <div className=" row container-fluid " md="12" sm="12" xs="12" lg="12" xl="12">
                    <div className="td__header mb_20" >
                        <div className=" td__header-content" md="6" sm="6" xs="6" lg="6" xl="6">
                            <h2>Helios</h2>
                                <p><br />Helios is an easy to use portal <br /> that provide a single pane of glass view of your data products, <br />ability to manage them, susbcribe to platform services and govern them. ​</p>
                        </div>
