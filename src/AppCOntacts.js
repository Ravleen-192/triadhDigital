...
const links = [
  ...
  { href: '#services', text: 'Services', menuId: 1, },
  { href: '#products', text: 'Products', menuId: 2, },
  { href: '#company', text: 'Company', menuId: 3, },
  { className: "frmbtn2", href: '#contact', text: 'Lets Talk', menuId: 5, },
    ...
    return (
      <div>
        ...
        <BrowserRouter>
          ...
          <Switch>
            <Route exact path="/Theia" component={withRouter(Theia)} />
            <Route exact path="/Helios" component={withRouter(Helios)} />
            <Route exact path="/Plutus" component={withRouter(Plutus)} />
          </Switch>
        </BrowserRouter>
